...
public class TagsActionTest {
  ...
  @Rule
  public EsTester esTester = new EsTester(IssueIndexDefinition.createForTest(new MapSettings().asConfig()), RuleIndexDefinition.createForTest(new MapSettings().asConfig()));
